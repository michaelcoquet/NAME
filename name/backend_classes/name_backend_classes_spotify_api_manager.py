...
class SpotifyAPIManager:
    ...
    def search_songs(self, song_list):
        ...
        for song in song_list:
            ...
            result = self.spotify.search(q=song, limit=5, type="track")
            ...
            for found_song in result["tracks"]["items"]:
                ...
                audio_features = self.get_audio_features(song_info["id"])
                song = S.Song(song_info, audio_features)
...
# test2 = SpotifyAPIManager()
# search_songs = test2.search_songs(['Breakeven'])
# print(search_songs)