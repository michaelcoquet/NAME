...
from name.backend_classes import TemporaryStorage
...
def test_playlist_v1():
    ...
    # ******TEMPORARY TEMP STORAGE TEST REMOVE IF YOU SEE THIS
    #temp = TemporaryStorage(playlist_obj)
